...
requireText('service', 'RETENTION_DAYS = 30')
...
requireText('service', 'stable_pseudonyms_exposed_to_operators: false')
...
requireText('routes', 'assertClosedPilotEmailAllowed(citizen.email)')
requireText('routes', 'PILOT_ACCOUNT_INACTIVE')
