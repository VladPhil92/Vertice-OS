...
requireText('policy', 'FULL_GIT_COMMIT_SHA')
requireText('policy', '/^[0-9a-f]{40}$/i')
requireText('policy', 'runtime:revision_invalid')
...
requireText('policyTest', 'runtime:revision_invalid')
requireText('policyTest', "'main'")
