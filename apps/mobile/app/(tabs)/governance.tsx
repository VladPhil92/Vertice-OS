...
const styles = StyleSheet.create({
  ...
  status: { textTransform: 'uppercase', color: colors.navy, fontFamily: typography.bodyExtraBoldFamily, fontSize: 10, letterSpacing: 1.1, fontWeight: '800' },
  scope: { textTransform: 'uppercase', color: colors.textTertiary, fontFamily: typography.bodyBoldFamily, fontSize: 10, fontWeight: '700' },
  ...
  tallyKicker: { color: colors.textTertiary, fontFamily: typography.bodyExtraBoldFamily, fontSize: 9, fontWeight: '800', letterSpacing: 1 },
  tallyTitle: { color: colors.textPrimary, fontFamily: typography.bodyExtraBoldFamily, fontWeight: '800', fontSize: 12 },
  ...
  eligibilityTitle: { color: colors.textPrimary, fontFamily: typography.bodyExtraBoldFamily, fontWeight: '800', fontSize: 13 },
  ...
  remediationButtonText: { color: colors.navy, fontFamily: typography.bodySemiboldFamily, ...typography.roles.caption },
