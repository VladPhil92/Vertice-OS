      ...
      >
        <View style={styles.headerRow}>
          <View style={styles.headerCopy}>
            <Text style={styles.eyebrow}>GESTIÓN SOCIAL</Text>
            <Text style={styles.title}>Acciones cívicas</Text>
            <Text style={styles.subtitle}>Problema → acción → evidencia → reputación verificable.</Text>
          </View>
        ...
        {showCreate ? (
          <View style={styles.formCard}>
            ...
            <TextInput style={styles.input} placeholder="Barrio o territorio" value={form.neighborhood} onChangeText={(neighborhood) => setForm((prev) => ({ ...prev, neighborhood }))} />
