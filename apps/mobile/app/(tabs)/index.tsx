...
const styles = StyleSheet.create({
  ...
  liveBadgeText: { color: colors.textSecondary, fontFamily: typography.bodyExtraBoldFamily, fontSize: 10, fontWeight: '800', letterSpacing: 0.8 },
  ...
  territoryPrimaryText: { color: colors.white, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.button, textAlign: 'center' },
  ...
  territorySecondaryText: { color: colors.navy, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.button, textAlign: 'center' },
  ...
  sectionKickerLight: { color: colors.citizen, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.label },
  ...
  mutedLight: { color: colors.borderActive, fontFamily: typography.bodySemiboldFamily, ...typography.roles.caption },
  ...
  launchKicker: { color: colors.textTertiary, fontFamily: typography.bodyExtraBoldFamily, fontSize: 9, fontWeight: '800', letterSpacing: 1 },
