...
const styles = StyleSheet.create({
  ...
  brandContext: { color: colors.textTertiary, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.label },
  ...
  backButtonText: { color: colors.navy, fontFamily: typography.bodySemiboldFamily, ...typography.roles.caption },
  ...
  lead: { color: colors.textSecondary, fontFamily: typography.bodyFamily, ...typography.roles.subtitle },
  ...
  retentionKicker: { color: colors.infoText, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.label },
  ...
  warningKicker: { color: colors.errorText, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.label },
  ...
  item: { color: colors.textSecondary, fontFamily: typography.bodyFamily, ...typography.roles.body },
  body: { color: colors.textSecondary, fontFamily: typography.bodyFamily, ...typography.roles.body },
  warningBody: { color: colors.errorText, fontFamily: typography.bodyFamily, ...typography.roles.body },
  label: { color: colors.errorText, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.label },
  input: {
  ...
  deleteButtonText: { color: colors.white, fontFamily: typography.bodyExtraBoldFamily, ...typography.roles.button },
